...
static int secp256k1_s2c_commit_is_init(const secp256k1_schnorr_s2c_opening *opening) {
...
int secp256k1_schnorr_s2c_opening_parse(const secp256k1_context* ctx, secp256k1_schnorr_s2c_opening* opening, const unsigned char *input33) {
    unsigned char pk_ser[33];
    VERIFY_CHECK(ctx != NULL);
    ARG_CHECK(opening != NULL);
    ARG_CHECK(input33 != NULL);

    secp256k1_schnorr_s2c_opening_init(opening);
...
int secp256k1_schnorr_s2c_opening_serialize(const secp256k1_context* ctx, unsigned char *output33, const secp256k1_schnorr_s2c_opening* opening) {
    size_t outputlen = 33;
