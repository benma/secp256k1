 ...
 *                 in.
 *  In:   opening: a pointer to an initialized `secp256k1_schnorr_s2c_opening`.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_schnorr_s2c_opening_serialize(
    const secp256k1_context* ctx,
